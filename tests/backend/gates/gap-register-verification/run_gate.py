#!/usr/bin/env python3
"""CLI entry for gap-register CheckPhaseGate."""
...
from gap_register_gate.checks import run_all_checks  # noqa: E402
from gap_register_gate.gate import check_phase_gate  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Astloom gap-register verification gate")
    ...
    if args.json:
        ...
        print(f"Gap-register gate: {gate['status']} ({gate['passed_count']} passed, {gate['failed_count']} failed)")
