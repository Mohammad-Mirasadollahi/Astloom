#!/usr/bin/env python3
"""CLI entry for logical-examples CheckPhaseGate."""
...
from logical_examples_gate.checks import run_all_checks  # noqa: E402
from logical_examples_gate.gate import check_phase_gate  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Astloom logical-examples verification gate")
    ...
    if args.json:
        ...
        print(f"Logical-examples gate: {gate['status']} ({gate['passed_count']} passed, {gate['failed_count']} failed)")
