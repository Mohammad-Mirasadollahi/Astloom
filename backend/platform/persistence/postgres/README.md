...
Path: `backend/platform/persistence/postgres`

## Purpose

Relational persistence integration boundary.
...
Active PostgreSQL platform baseline. `0000_extensions.sql` enables the approved pgvector and pg_trgm extensions; each service owns its tables and migrations.
