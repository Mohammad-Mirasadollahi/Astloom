"""`astloom inventory` CLI entrypoint."""
...
from astloom_cli.commands.inventory.render import format_detail_text, print_human
from astloom_cli.commands.inventory.words import parse_inventory_words


def cmd_inventory(args: argparse.Namespace) -> int:
    detail, save_path = parse_inventory_words(getattr(args, "words", None))
