...
Path: `backend/packages/contracts/events`

## Purpose

Event envelope and payload contract definitions.
...
Minimal implementation: `envelope.py` with `REQUIRED_ENVELOPE_FIELDS`, `make_event_envelope`, and `validate_event_envelope`.
