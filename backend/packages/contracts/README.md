...
Shared public API, event, config, and schema contracts.
...
- `api/` for API request, response, error, pagination, filtering, sorting, and idempotency contracts.
- `examples/` for valid and invalid contract examples used by tests.
