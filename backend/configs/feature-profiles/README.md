...
Path: `backend/configs/feature-profiles`

## Purpose

Feature profile configuration templates.
...
Schemas are normative. First-party `default.json` must validate against `feature-profile.schema.json`. See `docs/04-rule-engine-orchestration/08-domain-pack-feature-profile-and-rule-suggestion-schemas.md`.
