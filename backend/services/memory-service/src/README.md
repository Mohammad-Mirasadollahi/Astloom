...
Path: `backend/services/memory-service/src`

## Purpose

Service source root. Parent service: `services/memory-service`.
...
Active. The `memory_service` package contains domain behavior, application orchestration, HTTP interfaces, the PostgreSQL adapter, composition root, and deterministic test fake.
