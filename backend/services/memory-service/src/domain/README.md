...
Path: `backend/services/memory-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/memory-service`.
