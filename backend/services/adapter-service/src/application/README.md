...
Path: `backend/services/adapter-service/src/application`

## Purpose

Use cases, command handlers, query handlers, and orchestration inside this service boundary. Parent service: `services/adapter-service`.
