...
Path: `backend/services/adapter-service/src/contracts`

## Purpose

Service-owned public contracts and examples before promotion to shared contracts. Parent service: `services/adapter-service`.
