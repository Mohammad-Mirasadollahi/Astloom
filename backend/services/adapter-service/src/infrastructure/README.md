...
Path: `backend/services/adapter-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/adapter-service`.
