...
Path: `backend/services/adapter-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/adapter-service`.
