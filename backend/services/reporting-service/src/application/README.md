...
Path: `backend/services/reporting-service/src/application`

## Purpose

Use cases, command handlers, query handlers, and orchestration inside this service boundary. Parent service: `services/reporting-service`.
