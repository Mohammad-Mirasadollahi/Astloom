...
Path: `backend/services/reporting-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/reporting-service`.
