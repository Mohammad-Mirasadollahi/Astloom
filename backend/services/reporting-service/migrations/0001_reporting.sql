...
CREATE INDEX IF NOT EXISTS reporting_documents_scope_kind_idx
    ON reporting.documents (tenant_id, workspace_id, project_id, kind, kpi_name, created_at, id);
