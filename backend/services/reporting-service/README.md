...
Path: `backend/services/reporting-service`

## Purpose

Owns impact, quality, token, and benefit reporting.
...
Vertical slice implemented. Canonical tests live under `tests/backend/services/reporting-service/`.
