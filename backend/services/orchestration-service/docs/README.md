...
Path: `backend/services/orchestration-service/docs`

## Purpose

Service-specific implementation notes and local design records. Parent service: `services/orchestration-service`.
