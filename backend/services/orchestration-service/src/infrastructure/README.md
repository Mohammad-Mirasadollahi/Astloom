...
Path: `backend/services/orchestration-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/orchestration-service`.
