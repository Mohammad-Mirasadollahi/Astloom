...
Path: `backend/services/orchestration-service/src/interfaces`

## Purpose

Inbound API, worker, event consumer, and CLI adapters. Parent service: `services/orchestration-service`.
