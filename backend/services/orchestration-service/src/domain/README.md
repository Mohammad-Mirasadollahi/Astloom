...
Path: `backend/services/orchestration-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/orchestration-service`.
