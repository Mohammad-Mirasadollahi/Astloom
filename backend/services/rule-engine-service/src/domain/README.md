...
Path: `backend/services/rule-engine-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/rule-engine-service`.
