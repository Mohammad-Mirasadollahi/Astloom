...
Path: `backend/services/rule-engine-service/src/contracts`

## Purpose

Service-owned public contracts and examples before promotion to shared contracts. Parent service: `services/rule-engine-service`.
