...
Path: `backend/services/rule-engine-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/rule-engine-service`.
