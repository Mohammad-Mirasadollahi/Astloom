...
Path: `backend/services/rule-engine-service/src/interfaces`

## Purpose

Inbound API, worker, event consumer, and CLI adapters. Parent service: `services/rule-engine-service`.
