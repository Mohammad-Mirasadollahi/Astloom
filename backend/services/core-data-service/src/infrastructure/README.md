...
Path: `backend/services/core-data-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/core-data-service`.
...
Active PostgreSQL persistence boundary. `core_data_service.postgres_store.PostgresStore` implements the service Store port; schema changes remain owned by `migrations/`.
