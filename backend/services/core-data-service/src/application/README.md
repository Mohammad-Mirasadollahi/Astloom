...
Path: `backend/services/core-data-service/src/application`

## Purpose

Use cases, command handlers, query handlers, and orchestration inside this service boundary. Parent service: `services/core-data-service`.
