...
Path: `backend/services/core-data-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/core-data-service`.
