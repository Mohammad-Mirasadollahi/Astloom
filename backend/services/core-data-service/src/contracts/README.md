...
Path: `backend/services/core-data-service/src/contracts`

## Purpose

Service-owned public contracts and examples before promotion to shared contracts. Parent service: `services/core-data-service`.
