...
Path: `backend/services/core-data-service/migrations`

## Purpose

Service-owned persistence migrations. Parent service: `services/core-data-service`.
...
Active. `0001_core_data.sql` owns the `core_data` schema, scoped records, durable idempotency records, and outbox events.
