...
Path: `backend/services/audit-service/src/contracts`

## Purpose

Service-owned public contracts and examples before promotion to shared contracts. Parent service: `services/audit-service`.
