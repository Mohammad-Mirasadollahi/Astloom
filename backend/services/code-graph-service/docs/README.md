...
Path: `backend/services/code-graph-service/docs`

## Purpose

Service-specific implementation notes and local design records. Parent service: `services/code-graph-service`.
