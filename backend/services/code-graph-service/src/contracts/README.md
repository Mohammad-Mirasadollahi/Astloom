...
Path: `backend/services/code-graph-service/src/contracts`

## Purpose

Service-owned public contracts and examples before promotion to shared contracts. Parent service: `services/code-graph-service`.
