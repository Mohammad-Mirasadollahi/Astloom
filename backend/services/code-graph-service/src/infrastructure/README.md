...
Path: `backend/services/code-graph-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/code-graph-service`.
