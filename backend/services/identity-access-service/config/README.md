...
Path: `backend/services/identity-access-service/config`

## Purpose

Service-specific configuration schema and templates. Parent service: `services/identity-access-service`.
