...
Path: `backend/services/identity-access-service/src/interfaces`

## Purpose

Inbound API, worker, event consumer, and CLI adapters. Parent service: `services/identity-access-service`.
