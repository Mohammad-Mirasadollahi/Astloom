...
Path: `backend/services/identity-access-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/identity-access-service`.
