...
Path: `backend/services/identity-access-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/identity-access-service`.
