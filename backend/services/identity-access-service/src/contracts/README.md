...
Path: `backend/services/identity-access-service/src/contracts`

## Purpose

Service-owned public contracts and examples before promotion to shared contracts. Parent service: `services/identity-access-service`.
