...
Path: `backend/services/identity-access-service/docs`

## Purpose

Service-specific implementation notes and local design records. Parent service: `services/identity-access-service`.
