...
Path: `backend/services/project-profile-service/config`

## Purpose

Service-specific configuration schema and templates. Parent service: `services/project-profile-service`.
