...
Path: `backend/services/project-profile-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/project-profile-service`.
