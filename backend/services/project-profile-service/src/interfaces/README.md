...
Path: `backend/services/project-profile-service/src/interfaces`

## Purpose

Inbound API, worker, event consumer, and CLI adapters. Parent service: `services/project-profile-service`.
