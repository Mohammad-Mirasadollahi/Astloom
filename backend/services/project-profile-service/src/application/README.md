...
Path: `backend/services/project-profile-service/src/application`

## Purpose

Use cases, command handlers, query handlers, and orchestration inside this service boundary. Parent service: `services/project-profile-service`.
