...
Path: `backend/services/project-profile-service/docs`

## Purpose

Service-specific implementation notes and local design records. Parent service: `services/project-profile-service`.
