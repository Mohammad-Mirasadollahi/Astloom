...
Path: `backend/services/docs-sync-service/src/application`

## Purpose

Use cases, command handlers, query handlers, and orchestration inside this service boundary. Parent service: `services/docs-sync-service`.
