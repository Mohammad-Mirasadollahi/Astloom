...
Path: `backend/services/docs-sync-service/src/domain`

## Purpose

Pure domain model, entities, value objects, domain services, and invariants. Parent service: `services/docs-sync-service`.
