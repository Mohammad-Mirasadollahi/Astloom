...
Path: `backend/services/docs-sync-service/src/infrastructure`

## Purpose

Persistence, messaging, provider, and external infrastructure adapters. Parent service: `services/docs-sync-service`.
